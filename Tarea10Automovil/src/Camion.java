public class Camion implements Vehiculo{
    ...
    public boolean encender() {
        System.out.println("Encendiendo el camion. El combustible marca " +  this.combustible);
        return Math.random() <= 0.2;
    }

    @Override
    public boolean apagar() {
        System.out.println("Apagando el camion. El combustible marca " +  this.combustible);
